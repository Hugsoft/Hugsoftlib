...
/**
 * A Composable function that lays out elements vertically in a grid with evenly sized columns.
 *
...
/**
 * A Composable function that lays out elements in a staggered grid with rows of uneven height.
 *
 * @param modifier The modifier to be applied to the layout.
